...
angular.module('MetronicApp').controller('ListarTiposVehiculosController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
...
$rootScope.$state.go('login');
        ...
        grid.init({
            ...
            dataTable: { 
                ...
                "ajax": {
                    url: "database/TipoVehiculoGet.php?action_type=list", // ajax source
                    dataSrc: "data",
					type: "POST",
                            ...
                            return '<div class="btn-group">' +
                                        '<button class="btn btn-xs btn-warning dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Acciones <i class="fa fa-angle-down"></i></button>' +
                                         '<ul class="dropdown-menu pull-right" role="menu">' +
                                            '<li><a href=#/private/registrar_tipo_vehiculo/' + data['idtipos_vehiculo'] + '><i class="icon-docs"></i> Editar</a></li>' +
                                            '<li><a href="javascript:;" data-id="' + data['idtipos_vehiculo'] + '" class="mt-sweetalert delete"><i class="fa fa-times"></i> Eliminar</a></li>' +
                                        '</ul>' +
                                    '</div>';               
                          }
                        }
		...
		/*******************************/
		$('#datatable_tipos_vehiculos tbody').on( 'click', 'a.mt-sweetalert', function () {
			...
			var confirm_delete = swal({
						...
						function(){
							...
							$.ajax({
								dataType:'JSON',
								type: 'POST',
								url: 'database/TipoVehiculoGet.php?action_type=delete&id='+data['idtipos_vehiculo'],
