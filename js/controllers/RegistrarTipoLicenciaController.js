...
angular.module('MetronicApp').controller('RegistrarTipoLicenciaController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
				...
				if (idItem != '' && idItem != 'nuevo') {
					...
					//CAMPOS DE EDICION							
					 $.ajax({
						dataType:'JSON',
						type: 'POST',
						url: 'database/TipoLicenciaGet.php?action_type=edit&id='+idItem,
						success:function(data){
							//INICIO DE PERSONALIZACION DE CAMPOS
							$('#tipo_licencia').val(data.tipo_licencia);
							$("#estado_tipo_licencia").val(data.estado_tipo_licencia).change();
					...
					$("#estado_tipo_licencia").val(1).change().selectpicker('refresh');
				 ...
				 form1.validate({
						...
						submitHandler: function (form) {
								...
								$.ajax({
										dataType:'JSON',
										type: 'POST',
										url: 'database/TipoLicenciaGet.php',
										data: formdata,
										success:function(data){
											...
											$rootScope.$state.go('private.listar_tipos_licencias');
