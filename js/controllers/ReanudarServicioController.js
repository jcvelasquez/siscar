...
angular.module('MetronicApp').controller('ReanudarServicioController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
...
$rootScope.$state.go('login');
		...
		/**********************************************/
		$( "#grabar_reanudar_servicio" ).click(function() {
			
				 var form_reanudar_servicio = $('#form_reanudar_servicio');
				 var error_reanudar_servicio = $('.alert-danger.items', form_reanudar_servicio);

				 form_reanudar_servicio.validate({
						...
						invalidHandler: function (event, validator) { 
							error_reanudar_servicio.show();
							App.scrollTo(error_reanudar_servicio, -55);
						},
						...
						submitHandler: function (form) {
								...
								error_reanudar_servicio.hide();
								
								formdata = $("#form_reanudar_servicio").serialize()+'&action_type=create_reanudar_servicio&idservicio_solicitud=' + idItem;

								swal({title: "CONFIRMACION REQUERIDA",
									  text: "¿Esta seguro que desea reanudar el servicio?",
									  type: "warning",
									...
									function(){
												...
												$.ajax({
														...
														success:function(data){
															...
															msg = "La reanudacion del servicio se registro correctamente con #ID " + data.idservicios_estados;
