...
angular.module('MetronicApp').controller('RegistrarTipoIdentificacionController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
				 ...
				 form1.validate({
						...
						submitHandler: function (form) {
								...
								$.ajax({
										dataType:'JSON',
										type: 'POST',
										url: 'database/TipoIdentificacioneGet.php',
										data: formdata,
										success:function(data){
											...
											$rootScope.$state.go('private.listar_tipos_identificacion');
