...
/* Setup general page controller */
angular.module('MetronicApp').controller('ListarEvaluacionesMantenimientoController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
                            ...
                            return '<div class="btn-group">' +
                                        '<button class="btn btn-xs btn-warning dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> <i class="fa fa-gear"></i> Acciones <i class="fa fa-angle-down"></i></button>' +
                                         '<ul class="dropdown-menu pull-right" role="menu">' +
                                            '<li><a href=#/private/registrar_evaluacion_mantenimiento/' + data['idmantenimiento_evaluaciones'] + '/' + data['idmantenimiento_solicitudes'] + '><i class="fa fa-pencil"></i> Editar evaluación</a></li>' +
                                            '<li><a href="javascript:;" data-id="' + data['idmantenimiento_evaluaciones'] + '" class="mt-sweetalert delete"><i class="fa fa-times"></i> Eliminar evaluación</a></li>' +
											'<li class="divider"></li>' +
											//'<li><a href="javascript:;"><i class="fa fa-check"></i> Aprobar evaluacion</a></li>' +
											'<li><a href="javascript:;" class="generar_orden"><i class="fa fa-car"></i> Generar orden trabajo</a></li>' +
                                        '</ul>' +
                                    '</div>';               
                          }
                        }
