...
/* Setup general page controller */
angular.module('MetronicApp').controller('ListarMantenimientoComponentesController', ['$rootScope', '$scope', 'settings', function($rootScope, $scope, settings) {
...
$rootScope.$state.go('login');
		...
		grid.init({
			src: $("#datatable_mantenimiento_componentes"),
			...
			dataTable: { 
				...
				"pageLength": 20, 
				"ajax": {
					url: "database/MantenimientoComponentesGet.php?action_type=list",
					dataSrc: "data"
				},
				columns: [
						{ data : "idmantenimiento_componentes" },		
						{
							  ...
							  "mRender": function(data, type, full) {
										return '<a href=#/private/registrar_mantenimiento_componente/' + data['idmantenimiento_componentes'] + '>' + data['cod_componente'] + '</a>';
							...
							return '<div class="btn-group">' +
										'<button class="btn btn-xs btn-warning dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Acciones <i class="fa fa-angle-down"></i></button>' +
										 '<ul class="dropdown-menu pull-right" role="menu">' +
											'<li><a href=#/private/registrar_mantenimiento_componente/' + data['idmantenimiento_componentes'] + '><i class="icon-docs"></i> Editar</a></li>' +
											'<li><a href="javascript:;" data-id="' + data['idmantenimiento_componentes'] + '" class="mt-sweetalert delete"><i class="icon-docs"></i> Eliminar</a></li>' +
										'</ul>' +
									'</div>';               
						  }
						}
		...
		/*******************************/
		$('#datatable_mantenimiento_componentes tbody').on( 'click', 'a.mt-sweetalert', function () {
			...
			var rowToDelete = $(this).parents('tr');
					...
					function(){
							...
							$.ajax({
								dataType:'JSON',
								type: 'POST',
								url: 'database/MantenimientoComponentesGet.php?action_type=delete&id='+data['idmantenimiento_componentes'],
